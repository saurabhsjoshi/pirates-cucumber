Feature: Single Player Scoring with Treasure Chest
  ...
  Scenario: Row 82
    ...
    And 'Player1' rolls the following 'PARROT,PARROT,PARROT,SWORD,SWORD,DIAMOND,DIAMOND,GOLD_COIN'
    And 'Player1' puts dice with index '5 6 7' in treasure chest
    And 'Player1' re-rolls dice with index '3 4' to get the following 'PARROT,PARROT'
    And 'Player1' puts dice with index '0 1 2 3 4' in treasure chest
    And 'Player1' re-rolls dice with index '5 6 7' to get the following 'SKULL,GOLD_COIN,PARROT'
  ...
  Scenario: Row 86
    ...
    And The player names are the following 'Player1'
    When 'Player1' gets 'TREASURE_CHEST' fortune card
    And 'Player1' rolls the following 'SKULL,SKULL,PARROT,PARROT,PARROT,GOLD_COIN,GOLD_COIN,GOLD_COIN'
    And 'Player1' puts dice with index '5 6 7' in treasure chest
    And 'Player1' re-rolls dice with index '2 3 4' to get the following 'DIAMOND,DIAMOND,GOLD_COIN'
